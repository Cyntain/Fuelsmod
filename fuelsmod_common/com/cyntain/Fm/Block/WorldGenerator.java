...
public class WorldGenerator implements IWorldGenerator {
    ...
    private void generateSurface(World world, Random random, int chunkX, int chunkZ) {
        ...
        for(int i = 0; i < 25 ; i++){
            ...
            (new WorldGenMinable(BlockIDs.COPPER_ORE_DEFAULT, 8)).generate(world, random, xCord, yCord, zCord);
        }
        ...
        for(int i = 0; i < 25 ; i++){
            ...
            (new WorldGenMinable(BlockIDs.OSMIUM_ORE_DEFAULT, 8)).generate(world, random, xCord, yCord, zCord);
        }
        ...
        for(int i = 0; i < 25 ; i++){
            ...
            (new WorldGenMinable(BlockIDs.BERYLLIUM_ORE_DEFAULT, 8)).generate(world, random, xCord, yCord, zCord);
        }
