...
public class itemZeoliteVial extends ItemFood  {
   ...
   public static final String [] VIAL_NAME = new String[] {"Zeo","Reden", "Greue", "Yellen", "Lueel"};
    public  static final String [] DISCOVER = new String[] { "Invisablity", "Fire Resistance", "Healing", "Night Vision", "Breath" };
...
@SideOnly(Side.CLIENT)
    ...
    public void updateIcons(IconRegister iconregister) {
        ...
        for (int i = 0; i < VIAL_NAME.length; ++i) {
            icons[i] = iconregister.registerIcon(Reference.MOD_ID.toLowerCase() + ":" + Strings.ZEOLITE_DUST_GLASS_NAME + VIAL_NAME[i]);
        }
	...
	public void addInformation(ItemStack itemStack, EntityPlayer player, List list, boolean par){  
        ...
        case 0: 
         list.add("Tasty! But where does it keep going?");
             ...
             if(effect1 == true)
                 {
                 list.add(Colours.WHITE + "Effect:" + " " + Colours.RED + DISCOVER[meta].toUpperCase());
                     }else{
        ...
        case 4:
            ...
            default:
            list.add("Tasty!");
            list.add(Colours.WHITE + "Effect:" + " " + Colours.GRAY + "Unknown".toUpperCase());break;
...
private void addPotionEffects(ItemStack itemStack, World world, EntityPlayer player) {
    ...
    switch(meta){
    case 0: player.addPotionEffect(new PotionEffect(potionEffect[0], potionDuration[0] * 20, potionTeir[0]));break;
    case 1: player.addPotionEffect(new PotionEffect(potionEffect[1], potionDuration[0] * 20, potionTeir[0]));break;
    case 2: player.addPotionEffect(new PotionEffect(potionEffect[2], potionDuration[0] * 20, potionTeir[0]));break;
    case 3: player.addPotionEffect(new PotionEffect(potionEffect[3], potionDuration[0] * 20, potionTeir[0]));break;
    case 4: player.addPotionEffect(new PotionEffect(potionEffect[4], potionDuration[0] * 20, potionTeir[0]));break;
   
    default: player.addPotionEffect(new PotionEffect(potionEffect[4], potionDuration[0] * 20, potionTeir[0]));break;
    }
}
